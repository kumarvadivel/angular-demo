                    ...
                    'formSubmitFlow': [
                        ...
                        },
                        {
                            ...
                            "params": ['access_token', "loanUuid", [
                              ...
                              ], ['microservicetoken', 'oauthAccessToken'], ["applicantType", 'STATIC', 'BORROWER'], ["applicationSource", 'STATIC', 'WEB_JOURNEY'],"finacleRequest"],
                ...
                "KEY_FACT_DETAILS": {
                    ...
                    "formSubmitFlow": [
                          ...
                          },
                        {
                            "validationJson": {
                              "if": [
                                { "==": [{ "var": "capturedData.KEY_FACT_DETAILS.acceptStatus" }, 'ACCEPT'] },
                                "EXECUTE",
                                "NEXT"
                              ]
                            },
                        ...
                        "validateResponse": {"if": [{"==": [{"var": "capturedData.KEY_FACT_DETAILS.acceptStatus"}, 'ACCEPT']}, {"if": [{"==": [{"var": "fetchEligibilityData.output.plEligOutput.stpFlag"}, 'STP']}, 'LOAN_SUMMARY[JOURNEY_EVENT_CODE]KEY_FACT_ACCEPT', "LOAN_SUMMARY[JOURNEY_EVENT_CODE]KEY_FACT_ACCEPT"]}, 'CONTACT_BRANCH[JOURNEY_EVENT_CODE]KEY_FACT_DECLINE']},
                        "apiError": "PRODUCT_ERROR",
                    }],
                    "dataScopeFetchFlow": [{
                        "fetchflow": "fetchEligibilityData",
