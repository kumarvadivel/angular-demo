...
import { ViewDocumentPopupComponent } from '@pl-app/shared/components/view-document-popup/view-document-popup.component';
...
export class DocumentUploadV2Component implements OnInit {
    ...
    readOrigin() {
        ...
        return getOrigin.includes('localhost') ? window.origin + "/#" : window.origin + '/personal-loan' + "/#";
    }
