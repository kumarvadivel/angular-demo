...
import IdleTimer from '@pl-app/shared/helpers/IdleTimer.js';
...
export class AppComponent {
    ...
    constructor(
        ...
        this.linkinjector = this.injector.get<LinkInjectorService>(LinkInjectorService)
        ...
        this.linkinjector.createLinkForPreconnectOriginURL()
    }
