...
export class DynamicFieldsComponent implements OnInit {
    ...
    runValidationApiEndpoint(field, initialLoad, customDynamicList, skip_calculation,_initialLoadRulesForcall) {
    ...
    GstPanSearchParser(res,field){
        if(res.code=='200'){
          return {
            "mappingFields":{
              [field.fieldName]:res.mappingFields[field.fieldName]
            },
            "code":200
          }         
        }
    ...
    uploadFieldDocument(field) {
        ...
        this.theme1ApiService.uploadDocumentV3(params).then((res: any) => {
            if (res.code == '200') {
