...
export class SubmitFlowApiService {
  ...
  constructor(
    ...
    this.commonCommonService = this.injector.get<CommonCommonService>(
      CommonCommonService
    );
  }
  ...
  private apiCallJourneyPage(
    ...
    submitflow.dataCloud = this.commonCommonService.fetchDataCloud(
      submitflow,
      pageconfig
    );
    if (extraCloudParams) {
  ...
  proceedJourney(pageCode?, skipped?, pageconfig?) {
    ...
    this.initializeJourneyService.steppUpdaterforPageSequnece(
      nextpageCode,
      pageCode,
      journey,
      skipped,
  ...
  private submitFlowApiCalls({
    ...
    const API_NAME_MAPPING = {
      ...
      updateLoanApplicationTrackingStatus:
        "updateLoanApplicationTrackingStatus",
      ...
      "checkNPAValidation":"checkNPAValidation",
      "updateMainLoanApplicationStatus":"updateMainLoanApplicationStatus",
      "borrowerStepOne":"borrowerStepOne",
    };
