...
import { isNull, reject } from '@kcc-renewal-app/shared/utils/utils';
  ...
  @Input() field: any
    ...
    verifyAadharOtp(params) {
        let params1 = {
            ...
            subStatusChangeDescription:"aadhar verification-fail",
        ...
        this.theme1ApiService.verifyAadharOtp(params).then((res: any) => {
            ...
            if (res.code == '200') {
                ...
                this.theme1ApiService.updateLoanApplicationStatus(params1)
            }
        }, error => {
            this.theme1ApiService.updateLoanApplicationStatus(params1)
            this.showloader = false;
