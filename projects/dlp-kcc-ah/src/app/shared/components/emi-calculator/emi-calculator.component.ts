...
import { ConfigurationService } from '@kcc-ah-app/services/configuration.service';
...
export class EmiCalculatorComponent implements OnInit {
  ...
  constructor(public service :ConfigurationService,public theme1ApiService:ApiService,public commonVariableService:CommonVariableService,
    private route: ActivatedRoute,public commonService:CommonCommonService,public localStorage: LocalStorage
    ) { }
