...
import { Encrypt } from '@kcc-ah-app/shared/helpers/Encrypt';
...
import { CustomHttpParamEncoder } from '@kcc-ah-app/shared/helpers/customHttpEncoder';
import { Formatters } from '@kcc-ah-app/shared/helpers/Formatters';
@Injectable({
  providedIn: 'root'
})
export class CommonApiService {
  ...
  public doPostApiCallForUploadFile(url, requestBody, responseType?, customHeaders?) {
    const httpOptions = {
