...
import { Encrypt } from '@bl-app/shared/helpers/Encrypt';
...
import { CustomHttpParamEncoder } from '@bl-app/shared/helpers/customHttpEncoder';
import { Formatters } from '@bl-app/shared/helpers/Formatters';
@Injectable({
  providedIn: 'root'
})
export class CommonApiService {
  ...
  public doPostApiCallForUploadFile(url, requestBody, _responseType?, _params?, customHeaders?) {
    const httpOptions = {
