...
export class LandingComponent implements OnInit {
          ...
          sectionContent:{
            ...
            "options":{'columnSize':2,'layout':'sideLayout'},
              ...
              "validationJson":{
                "calculation":{
                //   "math.round":[
                //     {"+":[{"/":[{"var":"loanAmount"},{"var":"tenure"}]},{"/":[{"*":[{"var":"loanAmount"},{"*":[{"var":"interestRate"},0.01]}]},{"var":"tenure"}]}]},{"var":"tenure"}
                //  ]
                "-":[{"*":[{"var":"emiToBePaid"},{"var":"tenure"}]},{"var":"loanAmount"}]
                //"*":[{"var":'loanAmount'},{"var":"interestRate"},{"/":[{"var":"tenure"},12]}]
                }
              },
              "rulesFor":null,
              "regex":null,
  ...
  constructor(private router: Router, 
    ...
    public commonService:CommonCommonService,private initializeJourneyService:InitializeJourneyService) {
