...
import { MobileNumberVerificationComponent } from '@nsc-app-components/basic-information/components/mobile-number-verification/mobile-number-verification.component'; 
