...
import { EnvironmentService } from '@nsc-environments/environment.service';
import { JourneyEventsService } from './journey-events.service';
import { LocalStorage } from '@nsc-app/shared/helpers/LocalStorage';
import { Router } from '@angular/router';
import { find } from '@nsc-app/shared/utils/utils';
...
handleNoAccessTokenScenario(fetchflow){
  ...
  if(pageCodeData && pageCodeData.url){
