...
export class FileUploadComponent implements OnInit {
  ...
  constructor(public theme1ApiService: ApiService, public sharedService: SharedService, public commonVariableService: CommonVariableService, public localStorage: LocalStorage,
  ...
  groupFieldBasedongroup(fileUploadList: any) {
    const grouplist: any[] = [];
