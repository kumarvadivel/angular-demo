 ...
 VERIFY_PAN_V3 = `nsdlPanValidationService/nsdlPanValidation/check`;
  ...
  verifyMobileOtp(params,callMicroservice=true){ 
    if(callMicroservice){
      ...
      return this.commonApiService.doPostApiCall(this.BASE_URL_MICROSERVICE + this.VERIFY_MOBILE_MICROSERVICE,body,undefined,undefined,headersObj)
    }else{
  ...
  fetchBranchList() {
    let body = {}
    let encrypted = this.encryptFormBodyData_JSON(body)
    return this.commonApiService.doGetApiCall(this.BASE_URL_MICROSERVICE + this.MASTERDATA_BRANCH, encrypted.body)
  }
  ...
  genericPostApiFetch(params) {
    ...
    if (params['microservicetoken']) {
      ...
      return this.commonApiService.doPostApiCall(this.BASE_URL_MICROSERVICE + params.url, body, undefined, undefined, headers);
    } else {
      ...
      return this.commonApiService.doPostApiCall(this.BASE_URL + params.url, body, undefined, undefined, headers);
    }
  }
  prepareBody(params) {
    let body = {};
  ...
  prepareHeaders(microservicetoken,plainiv) {
  ...
  duplicateApplicationCheck(params){
    ...
    let encrypted  = this.encryptFormBodyData_JSON(body)
    return this.commonApiService.doGetApiCall(this.BASE_URL_MICROSERVICE+this.DUPLICATE_APPLICATION_CHECK,encrypted.body,{
      'Content-Type':'application/json',
      'Authorization':`Bearer ${params.microservicetoken}`,
      'clientApiKey':encrypted.plainiv
    })
