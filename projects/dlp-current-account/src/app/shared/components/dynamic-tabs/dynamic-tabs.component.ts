    ...
    termsAndConditionsInfo = [
                  {
                    ...
                    "isShow":true,
                      ...
                      "sectionContent":{
                        ...
                        "The customer herewith agrees to provide his/ her Valid Aadhaar number voluntary (if customer wishes to open Currents or Fixed deposit account through Video KYC) and Valid Pan Card Number. He/she understands that opening an account is subject to correct, complete, and accurate information as provided to Bank.",
                        ...
                        "This application is available for opening a currents account or Fixed Deposit by Resident Indian Individuals only.",
