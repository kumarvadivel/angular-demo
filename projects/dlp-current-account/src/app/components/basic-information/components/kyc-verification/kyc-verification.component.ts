...
import { ExistingRelationshipComponent } from '@ca-app/shared/components/existing-relationship/existing-relationship.component';
...
export class KycVerificationComponent implements OnInit {
  ...
  constructor(public ArrayMethods:ArrayMethod,private injector: Injector ,public dialog: MatDialog) { 
