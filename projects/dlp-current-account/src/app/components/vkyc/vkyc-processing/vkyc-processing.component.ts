    ...
    if (snap && snap != null) {
      ...
      this.apiService.fetchBorrowerDetails(params).then((res: any) => {
        ...
        if (res.code == '200') {
          ...
          this.initializeJourneyService.initializeJourney(this.commonVariableService.loanProductInfo.find(o => o.productCode === 'CA'), undefined, true, { "functionskel": this.vkycFlow, "arguments": this });
        }
