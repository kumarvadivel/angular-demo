...
export class CommonVariableService {
    ...
    loanProductInfo = [
        {
            id: 'term-loan-against-td/odr-loan',
            name:"Loan Against Term Deposit/OD",
            image: 'assets/icons/loan2.png',
            info: 'Emergency? Funds needed? Try Loan Against Term Deposit or Overdraft',
            color: '#197DFC',
            isActive: true,
            url: 'product/basicinfo/customer-type',
            showDescription: false,
            productCode: 'LAAODTDR',
