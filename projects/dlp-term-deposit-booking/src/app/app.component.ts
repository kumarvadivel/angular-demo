...
import {SharedService} from '@tlad-app/shared/services/utils/shared.service';
...
import IdleTimer from '@tlad-app/shared/helpers/IdleTimer.js';
...
export class AppComponent {
    ...
    navigateToExpiry() {
        if (this.localStorage.getItem('CURRENT_JOURNEY') && !this.commonVariableService.tenentConfiguration.devMode) {
