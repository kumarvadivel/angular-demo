...
import appConfiguration from '@ssa-app/app.config.json'
...
export class ApiService {
 ...
 BRANCH_STATE_MASTER =`/api-v3/restPublic/master-branch-list-new`;
  ...
  prepareHeaders(microservicetoken,plainiv) {    return this.environmentService.configData.appConfig.isEncryption ?{
      'Content-Type': 'application/json',
