...
export class CommonVariableService {
    ...
    loanProductInfo = [
        ...
        {
            id: "dlp-sukanya-samriddhi-account",
            image: "assets/icons/loan2.png",
                    ...
                    "sectionContent": {
                        ...
                        "fields": [
                            //nominee
                            {
                                ...
                                "changeConfirmLogic": { "if": [{ "==": [{ "var": "nomineeRequired" }, "NO"] }, true, false] },
                                "changeConfimContent": {
                            ...
                            },
                            {
                                ...
                                "validationJson": {
                                    "showField": {
                                        "if": [{
                                            "and": [{ "==": [{ "var": "nomineeRequired" }, "YES"] }, { "<": [{ "getAge": [{ "var": "dateOfBirth" }] }, 18] }]
        ...
        "SSA": {
            "individual": {
                ...
                "PERSONAL_DETAILS": {
                    ...
                    // },
                    {
                        "validationJson":{"if":[{"and":[{"==":[{"var":"nomineeRequired"},"YES"]}, {
                            "==": [
                              {
                                "getObjectKeyValue": [
                                  {
