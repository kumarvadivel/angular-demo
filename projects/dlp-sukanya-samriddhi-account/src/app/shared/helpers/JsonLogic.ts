...
export class LogicFunctions {
    ...
    init() {
        ...
        this.Jsonlogic.add_operation("removeItemLs", this.removeItemLs);
    }
  ...
  appendPathFetch(path) {
    ...
    getVKYCLink(phone,crmLeadCode,loanPurposeUuid){ 
        let redirectUrl= `${window.origin}/#/vkyc/processing?encrypedParams=`+btoa(`mobileNumber=${phone}&crmLeadId=${crmLeadCode}&loanPurposeUuid=${loanPurposeUuid}`)
