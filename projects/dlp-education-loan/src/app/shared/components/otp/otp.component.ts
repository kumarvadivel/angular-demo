...
import {reject,isNull} from 'underscore';
import { SpinnerService } from '@el-app/shared/services/spinner.service';
...
export class OtpComponent implements OnInit,AfterViewInit {
  @Input() field: any
    ...
    handleFillEvent(value) {
        if(value == 111111){
            this.route.navigateByUrl('product/custom-information/student-details')
        } else {
        }
