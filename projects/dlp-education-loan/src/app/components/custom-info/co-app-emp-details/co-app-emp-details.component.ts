...
@Component({
  selector: 'app-co-app-emp-details',
  templateUrl: './co-app-emp-details.component.html',
  styleUrls: ['./co-app-emp-details.component.scss']
})
export class CoAppEmpDetailsComponent implements OnInit {
  ...
  submitValidationForProduct() {
    this.router.navigateByUrl('products/custom-information/college-details')
