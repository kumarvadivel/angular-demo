...
@Component({
  selector: 'app-scholar-finance',
  templateUrl: './scholar-finance.component.html',
  styleUrls: ['./scholar-finance.component.scss']
})
export class ScholarFinanceComponent implements OnInit {
  ...
  submitValidationForProduct() {
    this.router.navigateByUrl('products/custom-information/loan-details')
