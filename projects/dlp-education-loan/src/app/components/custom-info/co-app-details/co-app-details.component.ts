...
@Component({
  selector: 'app-co-app-details',
  templateUrl: './co-app-details.component.html',
  styleUrls: ['./co-app-details.component.scss']
})
export class CoAppDetailsComponent implements OnInit {
  ...
  submitValidationForProduct() {
    this.router.navigateByUrl('products/custom-information/coApplicantEmp-details')
