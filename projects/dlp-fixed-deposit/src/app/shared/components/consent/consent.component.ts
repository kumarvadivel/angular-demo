...
export class ConsentComponent implements OnInit {
  ...
  isInvalid:any = false;
  isExpandIndex = [];
  popupConsentEnums=['Privacy_Policy_SBA','CJ-CC-PrivacyPolicy','PRIVACY_POLICY_PL','PRIVACY_POLICY_VL','Privacy_Policy_FD']
  idConsentRemaps = {
    'Privacy_Policy_SBA':{
      'type':'POPUP',
  ...
  constructor(public dialog:MatDialog,public commonService:CommonCommonService,public commonVariableService:CommonVariableService,
    public apiService:ApiService,public localStorage:LocalStorage) { 
