  ...
  appendPathFetch(path) {
    ...
    getVKYCLink(phone,crmLeadCode,loanPurposeUuid){ 
        ...
        if(!window.origin.includes('localhost')){
           redirectUrl= `${window.origin}/savings-account/#/vkyc/processing?encrypedParams=`+btoa(`mobileNumber=${phone}&crmLeadId=${crmLeadCode}&loanPurposeUuid=${loanPurposeUuid}`)
        }else{
