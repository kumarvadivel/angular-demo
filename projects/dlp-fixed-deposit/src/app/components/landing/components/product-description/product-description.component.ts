...
export class ProductDescriptionComponent implements OnInit {
  ...
  constructor(public commonVariableService:CommonVariableService,
    ...
    this.commonCommonService.quickInitiateProduct('FDA');
  }
  ...
  ngOnInit() {
    setTimeout(()=>{
      ...
      this.productDescription = this.commonVariableService.productDesc['FDA'];
      this.productDescInfoTabs = this.commonVariableService.productDescInfoTabs['FDA'];
    })
