...
export class LogicFunctions {
  ...
  init() {
    ...
    this.Jsonlogic.add_operation(
      "findPinMasterObject",
      this.findPinMasterObject
    );
    ...
    this.Jsonlogic.add_operation(
      "shouldNotExceedLimit",
      this.shouldNotExceedLimit
    );
  }
  ...
  masterValue(masterkeyName) {
    let capturedData =
      document["jsonLogicRef"].localStorage.SessionGetItem("CURRENT_JOURNEY").metaData
        .capturedData;
  ...
  subFlowValue(masterkeyName) {
    let capturedData =
      document["jsonLogicRef"].localStorage.SessionGetItem("SUBFLOW").capturedData;
  ...
  findMasterObject(Mastercode, searchParam, searchValue, returnKey) {
    let data =
      document["jsonLogicRef"].localStorage.SessionGetItem("MASTER")[Mastercode];
