...
import { NgxSmoothDnDModule } from './modules/ngx-smooth-dnd.module';
...
@NgModule({
    ...
    providers: [Formatters, LocalStorage,LogicFunctions, Encrypt, ArrayMethod, {
        provide: MAT_DATE_LOCALE,
        useValue: 'en-GB'
    },
 {provide: MAT_SNACK_BAR_DEFAULT_OPTIONS, useValue: {duration: 2500}},]
})
export class SharedConsoleModule {
}
