...
import { ResumeVariableService } from '@cc-app/components/resume-application/services/resume-application-variable.service';
...
export class TrackStatusComponent implements OnInit {
  ...
  metaConfig;
  $scope: any = {}
  pageCode = 'RESUME_APPLICATION'
  constructor(public commonService: CommonCommonService, private activeRoute: ActivatedRoute, 
    public sharedService: SharedService, public resumeVariableService: ResumeVariableService, public commonVariableService: CommonVariableService,private localStorage:LocalStorage,public submitFlowApiService: SubmitFlowApiService) {
