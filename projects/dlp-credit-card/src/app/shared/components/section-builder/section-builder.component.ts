...
export class SectionBuilderComponent {
  ...
  constructor( private dialog: MatDialog,
    ...
    public formatters:Formatters,private localStorage:LocalStorage) {}
  ...
  cardEvent($event,index){
    this.status.emit({"ok":true,TriggerSection:'CARD',sectionIndex:index,data:$event})
  }
