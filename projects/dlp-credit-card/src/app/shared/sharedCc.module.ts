...
import { KnowMoreDialogComponent } from './components/know-more-dialog/know-more-dialog.component';
...
@NgModule({
  ...
  exports:[DynamicFieldsComponent,
    ...
    ScrollingModule
      ...
      providers:[Formatters,LogicFunctions,Encrypt,ArrayMethod,{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
