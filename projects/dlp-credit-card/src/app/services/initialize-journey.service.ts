...
import { isEqual } from "@cc-app/shared/utils/utils";
  ...
  journey: any;
    ...
    steppUpdaterforPageSequnece(nextPageCode, pageCode, journey, skipped, _currentPage) {
        if(this.router.url.includes('isPreviwUpdate')){
            if(pageCode == "MORE_INFO" && (journey.metaData.capturedData.MORE_INFO.borrowerEmploymentType != journey.metaData.globalScopeData.borrowerDetail.borrowerDetail.borrowerEmploymentType)){
                nextPageCode = 'EMPLOYMENT_DETAILS'
            }else{
