...
export class FetchFlowApiService {
  ...
  private fetchFlowApiCalls(
    ...
    const API_NAME_MAPPING = {
      'fetchFDDetails': 'fetchFDDetails',
      'fetchAllEligibleLoanPrograms': 'fetchCreditCardData',
      'fetchExistingCreditCardDetails': 'fetchExistingCCData',
      'fetchFDAccountsDetails': 'fetchFDAccountsData',
      'fetchGeneralAccountResponse': 'fetchGeneralAccountResponse',
      'npaCheck': 'npaCheck',
      'borrowerDetail': 'showBorrowerDetails',
      'loanDetailsWithoutBorrowerDetails': 'borrowerDetails',
      'documentList': 'getUploadedDoc',
      'showAllRequiredDocuments': 'getSupportingDoc',
      'fetchAddOnCardDetails': 'fetchAddOnCardDetails',
