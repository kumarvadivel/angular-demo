...
export class DynamicFieldsComponent implements OnInit {
    ...
    runValidationJson(field, initialLoad?, skip_calculation?, customDynamicList?,intialLoadRulesForCall?) {
        for (const specifiers in field.validationJson) {
            switch (specifiers) {
                ...
                case 'property':
                    ...
                    break;
                case 'apiEndpoint':
                    field = this.runValidationApiEndpoint(field, initialLoad, customDynamicList, skip_calculation,intialLoadRulesForCall);
                    break;
                case 'currentDate':
    ...
    runValidationApiEndpoint(field, initialLoad, customDynamicList, skip_calculation,intialLoadRulesForCall) {
