...
import { assign, uniqBy } from "@vldigi-app/shared/utils/utils";
...
export class CommonCommonService {
    ...
    apiCall(
{ submitflow, currentIndex, totalLength, pageCode, configList, pageconfig, extraCloudParams, noLoader }: { submitflow; currentIndex; totalLength; pageCode; configList; pageconfig?; extraCloudParams?; noLoader?; }    ) {
        this.submitFlowApiService.apiCall(
            { submitflow, currentIndex, totalLength, pageCode, configList, pageconfig, extraCloudParams, noLoader }        );
    }
