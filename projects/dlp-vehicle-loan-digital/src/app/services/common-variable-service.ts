            ...
            "individual": {
                        ...
                        "sectionContent": {
                            ...
                            "fields": [
                                ...
                                
                                {
                                    "fieldDataType": "BOOLEAN",
                                    "isMandatory": false,
                                    "fieldLabel": "I am a Vehicle Dealer",
                                    "fieldAccessModifier": "EDITABLE",
                                    "minLength": null,
                                    "maxLength": null,
                                    "error": null,
                                ...
                                },
                                {
                                    ...
                                    "validationJson": {
                                        "showField":{
                                            "if":[{"and":[{"!=":[{"var":"issourcingAgent"},true]},{"==":[{"var":"isvehicleDealer"},true]}]}]
                                        }
                                    },
                                    "rulesFor": null,
                                    "regex": null,
                                  ...
                                  },
                                {
                                    ...
                                    "rowNo": null,
                                    "columnNo": null,
                                    "placeholderText": "Enter Dealer Id",
                                    "fieldName": "dealerId",
                                    "labelInfo": null,
                                    "showLabel": true,
                                    "groupName": "",
                                ...
                                "options": [
                                    {
                                        ...
                                        "consentCode": "DND_CONSENT_SDVLN",
                                        "submitConsentCodes": [
                                            "DND_CONSENT_SDVLN",
                                            "PRIVACY_POLICY_SDVLN"
                                        ],
                                        "label": null,
                ...
                "MORE_INFO": [
                      ...
                      },
                    {
                        ...
                        "mandatory": true,
                        "sectionContent": {
                            "options": { "columnSize": 2,"mapSupplyData":true,"mapAndDisable":true,"autoVerifyMappedFields":true },
                                        ...
                                        "endLinks": [
                                            {
                                                ...
                                                "width": "70%",
                                                "linkType": "POPUP",
                                                "consentCode": "AADHAR_CONSENT_SDVLN",
                                                "popupContent": []
                                            }
                                        ]
                                    }
                        ...
                        "sectionContent": {
                            "config": {
                                "options": [
                                    {
                                        "consentType": "APIFETCH",
                                        "consentCode": "BUREAU_CONSENT_SDVLN",
                                        "submitConsentCodes": [
                                            "BUREAU_CONSENT_SDVLN"
                                        ],
                                        "label": null,
                                        "className": "check-container",
                                        "completed": null
          ...
          "sectionContent": {
            ...
            "fields": [
              ...
              },
              {
                "fieldDataType": "NUMBER",
                "isMandatory": true,
                "fieldLabel": "On Road Price as per Quotation",
                "commonpropertyType": null,
                "fieldAccessModifier": "EDITABLE",
                "minLength": null,
                "maxLength": 99999999,
                ...
                "groupName": "Vehicle Detail",
                "groupIndex": 0,
                "placeholderText": "On Road Price as per Quotation",
                "fieldName": "vehicleOwnedTextVariable1",
                "labelInfo": null,
                "showLabel": true,
                "showField": true
            },
        ...
        'SDVLN': {
            "individual": {
                    ...
                    },
                    {
                        ...
                        "params": [
                          ...
                          ["borrowerProfileTextVariable17","issourcingAgent"],
                            ...
                            ["borrowerProfileTextVariable26","isvehicleDealer"],
                            ["borrowerProfileTextVariable27","dealerId"]
                        ],
                        "validateResponse": {
                           "if": [
                               {
                ...
                "MORE_INFO": {
                    ...
                    "formSubmitFlow": [
                        {
                            "submitflow":"minimumAgeCriteriaCheck",
                            "dataFeedCloud": ['product', 'formValue', 'capturedData'],
                            "params":[],
                            "validateResponse":{
                                "if":[{
                                    "<":[{"getAge":[{"var":"panholderdob"}]},21]
                                },"PRODUCT_ERROR","PROCEED"]
                            }
                        },
                        {
