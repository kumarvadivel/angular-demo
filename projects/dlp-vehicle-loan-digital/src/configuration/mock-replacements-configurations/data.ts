...
export const commonProperty_static ={
    STATE: [
        {
            optionCode: "AN",
            optionKey: "AN",
...
export const loanProductInfo = [
    {
        id:"star-digi-vehicle-loan",
        image: "assets/icons/loan2.png",
        name: "Star Digi Vehicle Loan",
        ...
        "sectionContent": {
          "config": {
              "options": [
            {
                ...
                "consentCode": "TERMS_AND_CONDITIONS_CONSENT_SDVLN",
                "submitConsentCodes": [
                  "TERMS_AND_CONDITIONS_CONSENT_SDVLN"
                ],
                "label": null,
