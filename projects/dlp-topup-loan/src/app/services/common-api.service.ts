...
import { Encrypt } from '@tl-app/shared/helpers/Encrypt';
...
export class CommonApiService {
    ...
    public doGetApiCall(url, queryParams, customHeaders?) {
        return new Promise((resolve, reject) => {
            this.httpClient.get(url, {params: queryParams, headers: customHeaders || {},observe:"response"},).subscribe(
                (res:any) => {
                    return this.responseParsing(res,resolve)
                },
                err => {
                    reject(err);
                }
    ...
    returnPromise(url, requestBody, httpOptions) {
        return new Promise((resolve, reject) => {
            this.httpClient.post(url, requestBody, httpOptions).subscribe(
                res => {
                    return this.responseParsing(res,resolve)
                },
                err => {
