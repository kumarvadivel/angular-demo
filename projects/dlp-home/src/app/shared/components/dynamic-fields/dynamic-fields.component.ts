...
import { ApiService } from '@home-app/services/api.service';
...
import { Formatters } from '@home-app/shared/helpers/Formatters';
...
export class DynamicFieldsComponent implements OnInit {
    ...
    constructor(public commonVariableService: CommonVariableService,
                ...
                private sharedService:SnackBarService,
    ...
    initialFormatFields(field) {
        switch (field.fieldDataType) {
            ...
            case 'ACCOUNT_NO':
                ...
                break
            case 'DATE':
                field.maxDate = eval(field.maxDate);
                field.minDate = eval(field.minDate);
                break;
            case 'BOOLEAN':
    ...
    getDateFieldValue(field, initialValue) {
        if (initialValue == undefined) {
            if (field.value != null) {
                return typeof field.value == 'object' ? field.value.valueOf() : null
            } else {
                return null;
            }
        } else {
            if (field.initialState != null) {
                return typeof field.initialState == 'object' ? field.initialState.valueOf() :null
            } else {
                return null;
            }
        }
