...
export class ApiService {
 ...
 PREVIEW_DOCUMENT = `/api/v1/loanApplication/previewDocument`;
  ...
  updateLoanApplicationTrackingStatus(params){
    ...
    body = this.encryptFormBodyData(body)
    return this.commonApiService.doPostApiCall(this.BASE_URL + this.UPDATE_LOAN_APPLICATION_TRACKING_STATUS,body,undefined,undefined,this.commonVariableService.tenentConfiguration.ENCRYPT_FORM_BODY_DATA?this.commonVariableService.encryptionHeaders:undefined)
  }
