...
import { MobileNumberVerificationComponent } from '@ppf-app-components/basic-information/components/mobile-number-verification/mobile-number-verification.component'; 
