...
import { MobileNumberVerificationComponent } from '@sba-app-components/basic-information/components/mobile-number-verification/mobile-number-verification.component'; 
