...
import { FooterComponent } from '@sba-app-components/common//footer/footer.component';
import { HeaderComponent } from '@sba-app-components/common//header/header.component';
import { SideNavComponent } from '@sba-app-components/common//side-nav/side-nav.component';
import { UnauthorizedComponent } from '@sba-app-components/common//unauthorized/unauthorized.component';
...
import { BreadCrumbComponent } from '@sba-app-components/common/bread-crumb/bread-crumb.component';
