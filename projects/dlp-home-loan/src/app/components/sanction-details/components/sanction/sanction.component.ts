...
import { cloneDeep } from '@hl-app/shared/utils/utils';
@Component({
...
export class SanctionComponent implements OnInit {
    ...
    contentModeratorWithRespectToProduct() {
        if (this.journey.product.productCode == 'HL') {
            ...
            this.metaConfig.customData.maxLoanAmount=this.$scope.fetchEligibilityData.output.plEligOutput.overallLoanSanctionEligibilityAmount
            ...
            this.metaConfig.customData.sanctionedAmount=this.$scope.fetchEligibilityData.output.plEligOutput.productMaxLoanAmount
