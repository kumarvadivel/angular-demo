...
export class LogicFunctions {
    ...
    init() {
        ...
        this.Jsonlogic.add_operation("Arraylength", this.Arraylength)
        ...
        this.Jsonlogic.add_operation('findMasterObject', this.findMasterObject) //operator deperecated 
        ...
        this.Jsonlogic.add_operation('buildObject',this.buildObject)
    }
